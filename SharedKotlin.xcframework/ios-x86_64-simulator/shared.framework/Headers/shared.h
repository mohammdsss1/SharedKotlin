...
@class SharedPost, SharedFeed, SharedKotlinx_serialization_coreSerializersModule, SharedKotlinx_serialization_coreSerialKind, SharedKotlinNothing;
...
@interface SharedFeed : SharedBase
- (instancetype)initWithTitle:(NSString *)title link:(NSString *)link desc:(NSString *)desc imageUrl:(NSString * _Nullable)imageUrl posts:(NSArray<SharedPost *> *)posts sourceUrl:(NSString *)sourceUrl isDefault:(BOOL)isDefault __attribute__((swift_name("init(title:link:desc:imageUrl:posts:sourceUrl:isDefault:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (NSString *)component3 __attribute__((swift_name("component3()")));
- (NSString * _Nullable)component4 __attribute__((swift_name("component4()")));
- (NSArray<SharedPost *> *)component5 __attribute__((swift_name("component5()")));
- (NSString *)component6 __attribute__((swift_name("component6()")));
- (BOOL)component7 __attribute__((swift_name("component7()")));
- (SharedFeed *)doCopyTitle:(NSString *)title link:(NSString *)link desc:(NSString *)desc imageUrl:(NSString * _Nullable)imageUrl posts:(NSArray<SharedPost *> *)posts sourceUrl:(NSString *)sourceUrl isDefault:(BOOL)isDefault __attribute__((swift_name("doCopy(title:link:desc:imageUrl:posts:sourceUrl:isDefault:)")));
...
@property (readonly) NSArray<SharedPost *> *posts __attribute__((swift_name("posts")));
...
@interface SharedFeedCompanion : SharedBase
...
- (SharedPost *)doCopyTitle:(NSString *)title link:(NSString * _Nullable)link desc:(NSString * _Nullable)desc imageUrl:(NSString * _Nullable)imageUrl date:(int64_t)date __attribute__((swift_name("doCopy(title:link:desc:imageUrl:date:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface SharedPostCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
